...
//     version 1.14.2
//     from Assets/Custo.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Custo.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @Custo: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""Main"",
            ""id"": ""cd56e4c9-7c7f-4cc1-ac84-bfd8b0410079"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""Button"",
                    ""id"": ""45171efb-e9b0-493b-8b2a-084105857583"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""f2732cb5-5f44-4f08-b6bc-21d38396597c"",
    ...
    ~@Custo()
    {
        UnityEngine.Debug.Assert(!m_Main.enabled, "This will cause a leak and performance issues, Custo.Main.Disable() has not been called.");
    }
    ...
    {
        private @Custo m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public MainActions(@Custo wrapper) { m_Wrapper = wrapper; }
        /// <summary>
